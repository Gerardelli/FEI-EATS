...
import com.eats.fei.ui.principal.ui.slideshow.SlideshowFragment;
...
public class Todos extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewlista = root.findViewById(R.id.listTodos);
                ...
                if (dataSnapshot.exists()){
                    for (DataSnapshot produ: dataSnapshot.getChildren()){
                      ...
                      //  String descripcion = produ.child("descripcion").getValue().toString();
                        ...
                        adapter = new ArrayAdapter<>(Objects.requireNonNull(Todos.this.getContext()), android.R.layout.simple_list_item_1, listastrings);
