...
public class Dulces extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewlista = root.findViewById(R.id.listDulces);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    for (DataSnapshot produ: dataSnapshot.getChildren()){
                        ...
                        adapter = new ArrayAdapter<>(Objects.requireNonNull(Dulces.this.getContext()), android.R.layout.simple_list_item_1, listastrings);
